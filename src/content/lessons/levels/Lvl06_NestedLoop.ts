...
export default class Lvl06_NestedLoop implements Level {
    ...
    public readonly maxBlocks = 7; //actually only 6 blocks necessary
    public readonly mazeHeight = 15;
    public readonly mazeWidth = 15;
    public readonly name = "Verschachtelte Schleifen";
    ...
    tick(gameState: GameState): void {
        ...
        switch (standingOn) {
            ...
            case TILE_COLLECTIBLE:
                // Instantly wins game
                gameState.setGameOver(true, true, "Gut gemacht! " +
                    "Jetzt weist du das Wichtigste über Schleifen. Im nächsten Level kannst du dein Können unter Beweis stellen.");
                break;
        }

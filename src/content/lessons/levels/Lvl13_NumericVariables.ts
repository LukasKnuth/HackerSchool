...
export default class Lvl13_NumericVariables implements Level {
    ...
    public readonly name = "Numerische Variabeln";
    ...
    tick(gameState: GameState): void {
        ...
        switch (standingOn) {
            ...
            case TILE_COLLECTIBLE:
                // Instantly wins game
                gameState.setGameOver(true, true, "Super! Was glaubst du ist die größte Zahl, die du speichern kannst? Warum? Prüfe deine Vermutung nach.");
                break;
        }
